...
Write-Host "=== Infernal Ink & Steel - Start Web Dev ===" -ForegroundColor Cyan
...
try {
    ...
    $publishDir = "C:\InfernalInkSteelSuite\publish\Web"
    ...
    Write-Host "✅ SUCCESS: Web dev server started on $env:ASPNETCORE_URLS" -ForegroundColor Green
}
catch {
    $exitCode = 1
    Write-Host ""
    Write-Host "❌ FAILED: Web App failed to start or crashed" -ForegroundColor Red
